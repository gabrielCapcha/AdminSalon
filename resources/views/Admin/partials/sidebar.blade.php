    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="fas fa-balance-scale" style="padding-right:8px; padding-left:5px"></i>
              <p>
                Ventas
                <i class="fas fa-angle-left right"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="new-sale" class="nav-link">
                  <i class="#"></i>
                  <p>Crear nueva venta</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="list-sales" class="nav-link">
                  <i class="#"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="product" class="nav-link">
              <i class="fas fa-box" style="padding-right:8px; padding-left:5px"></i>
              <p>
                Productos
              </p>
            </a>
