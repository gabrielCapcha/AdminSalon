@extends('adminlte::layouts.app_products_features')
...
<a href="/new-feature"> {{ trans('message.create_new_feature') }} </a>
@endsection
              ...
              <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="row">
                  ...
                  <div class="col-sm-12" style="padding:10px;">
                    <table id="features" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                      <thead>
                        <tr role="row">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p id="deleteFeatureText"></p>
                          <br>
                          <input class="form-control" id="deleteFeatureComment" size="50" type="text" maxlength="100" placeholder="{{ trans('message.write_reason') }}" />
                        </div>
                        <div class="modal-footer">
                        <br>
                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">{{ trans('message.cancel') }}</button>
                            <button type="button" onClick="deleteFeatureSubmit()" class="btn btn-outline">{{ trans('message.acept') }}</button>
                        </div>
                      </div>
                    </div>
                  </div>
