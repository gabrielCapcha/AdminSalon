@extends('adminlte::layouts.app_products_guides')
...
@section('htmlheader_title')
	{{ trans('message.sidebar_products_9') }}
@endsection
            ...
            <div class="box-body">
              <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <table id="guides" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                      <thead>
                        <tr role="row">
