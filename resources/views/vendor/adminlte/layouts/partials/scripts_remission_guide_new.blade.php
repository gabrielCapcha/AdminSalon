    ...
    $(document).ready(function() {
        ...
        function finishNewSale() {
            ...
            if ((document.getElementById('traDriver').value != '0' && 
                ...
                (document.getElementById('typeDocument').value == 'GRI' ||
                document.getElementById('typeDocument').value == 'GRR')) {
                //LLAMADA AL LOADING
                ...
                data.selectedProducts.forEach(element => {
                    if (element.war_products_id != undefined) {
                ...
                if (endPoint != null) {
                    ...
                    if (endPoint != 0) {
                        data.customer.subsidiaries.forEach(elementSubsidiaries => {
                            if (elementSubsidiaries.id == endPoint) {
                                endPoint = elementSubsidiaries;
                            }
                        });
                    } else {
                        endPoint = null;
                ...
                var typeDocumentGR = document.getElementById('typeDocument').value;
                var noUpdateKardex = false;
                if (typeDocumentGR == 'GRR') {
                    typeDocumentGR = 'GRM';
                    noUpdateKardex = true;
                }
                ...
                if (saleValidation) {
                    data.sale = {
                        ...
                        "type_document_code": typeDocumentGR,
                    ...
                    if (document.getElementById('noUpdateStock').value == 0) {
            ...
            if (data.customerId != genericCustomer_.id && data.customerId != 0) {
                ...
                table = $('#searchQuotationTable').DataTable({
                    ...
                    "ajax": function(data, callback, settings) {
                            $.get('/api/search-document-by-customer-id/COT/' + customerId__, {
                                limit: data.length,
                                offset: data.start,
                                }, function(res) {
                                    var searchQuotationDataDetailResponse = '<h3>Cotizaciones disponibles: ' + res.length + '</h3>';
                    ...
                    "columns" : [
                        ...
                        { "data": function (data) {
                            var message = '';
                            if (data.sale_order != null) {
                                message = data.sale_order;
                            }
                            return message;
                        }},
                        { "data": function (data) {
                        ...
                        { "data": "created_at" },
                        { "data": function (data) {
                            var message = 'SIN DIRECCIÓN DE ENTREGA';
                            if (data.data_client != undefined) {
                                if (data.data_client[0]['destinySubsidiary'] != undefined) {
                                    message = data.data_client[0]['destinySubsidiary']['address'] + ', ' + data.data_client[0]['destinySubsidiary']['district'];
                                }                                
                            }
                            return message;
                        }},
            ...
            if (data.customerId != genericCustomer_.id && data.customerId != 0) {
                ...
                if (orderNumber != null) {
                    ...
                    data.selectedQuotations.forEach(element => {
                        ...
                        if (element.destinySubsidiary != undefined) {
                            document.getElementById('endPoint').value = element.destinySubsidiary.id;
                        }
                    });
        ...
        secondStepOfSale = function () {
            ...
            // allotment logic
            if (allotments.filter(Boolean).length != allotmentSelected.length) {
                document.getElementById('totalResumeAmount').innerHTML = 'INFORMACIÓN DE LOTES INCORRECTA';
                document.getElementById('tBodyTableProductsSummary').innerHTML = '';
                document.getElementById('tBodyTableQuotationSummary').innerHTML = '';                
                document.getElementById('saleErrorMessage').innerHTML = 'No se ingresó la información de lotes correctamente';
                document.getElementById('finishNewSale').disabled = true;
                document.getElementById('saleErrorMessage').className = 'btn btn-danger pull-center';                
            } else if (data.selectedProducts.length == 0) {
                document.getElementById('totalResumeAmount').innerHTML = 'AGREGUE PRODUCTOS A LA VENTA';
                document.getElementById('tBodyTableProductsSummary').innerHTML = '';
                document.getElementById('tBodyTableQuotationSummary').innerHTML = '';                
                document.getElementById('saleErrorMessage').innerHTML = 'No tiene productos por vender.';
                document.getElementById('finishNewSale').disabled = true;
                document.getElementById('saleErrorMessage').className = 'btn btn-danger pull-center';
                ...
                document.getElementById('tBodyTableProductsSummary').innerHTML = '';
                document.getElementById('tBodyTableQuotationSummary').innerHTML = '';                
                document.getElementById('saleErrorMessage').innerHTML = 'No se ha ingresado un cliente válido.';
                document.getElementById('finishNewSale').disabled = true;
                document.getElementById('saleErrorMessage').className = 'btn btn-danger pull-center';
            } else {
                setInterval();
                ...
                if (data.customer.flag_type_person == 2) {
                    ...
                    document.getElementById('clientName').innerHTML = data.customer.name + ' ' + data.customer.lastname + ' - DOC: ' + data.customer.dni;
                }
        ...
        addSelectedProduct = function (product, qEditable = true) {
            ...
            if (quantityProduct__ != null) {
                ...
                if (product.allotmentType == 1) {
                    ...
                    trInnerHTMLText_ = trInnerHTMLText_ + '<td class="static-table-td-grm"><div class="input-group input-group-sm"><span class="input-group-btn"><button type="button" id="btnAllotmentsSelectedProduct_' + product.id + '" style="padding-left: 8px; padding-right: 8px;" onclick="allotmentsSelectedProduct(' + product.id + ');" class="btn btn-primary btn-flat"><i class="fa fa-cubes"></i></button><span> </span>'+
        ...
        saveSearchQuotationSubmit = function () {
            if (searchQuotationObj != null) {
                searchQuotationObj.forEach(elementObj => {
                    var selectedQuotation = {
                        ...
                        saleOrder: elementObj.sale_order,
                        employeeId: elementObj.com_employees_id,
                        destinySubsidiary: elementObj.data_client[0].destinySubsidiary,
                        quotationProducts: []
                    };
                        ...
                        if (checkBoxSearchQuotation_ != null && checkBoxSearchQuotation_.checked) {
                            ...
                            if (Number(quantitySearchQuotationValue) > 0) {
                                ...
                                var selectedProductQuotation = {
                                    ...
                                    warProductsId: productElement.war_products_id,
                                };
            ...
            var table = $('#searchQuotationTable').DataTable();
            table.destroy();
            document.getElementById('searchSaleForm').disabled = true;
        ...
        allotmentsSelectedProduct = function (productId) {
            ...
            if (data.products[allotmentProductId]) {
                allotmentProductId_ = data.products[allotmentProductId].war_products_id;
                ...
                table = $('#tableAllotmentProduct').DataTable({
                    ...
                    "searching": true,
                    "ajax": function(data, callback, settings) {
                            $.get('/api/search-allotment-by-product-id/' + allotmentProductId_, {
                                limit: data.length,
                                offset: data.start,
                                }, function(res) {
        ...
        allotmentSubmit = function () {
            var btnAllotmentProduct  = document.getElementById('btnAllotmentsSelectedProduct_' + allotmentProductId);
            if (btnAllotmentProduct != null) {
                btnAllotmentProduct.className = 'btn btn-success btn-flat';
            }
        }
        allotmentValidation = function () {
            if (allotmentProductId != 0) {
                ...
                if (parseFloat(data.products[allotmentProductId].quantity) != parseFloat(quantityAllotmentTotal)) {
                    validation = true;                    
                }
