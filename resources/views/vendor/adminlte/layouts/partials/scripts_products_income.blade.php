...
<script>
    ...
    $(document).ready(function() {
        ...
        function autocompleteForProducts(inp) {
            ...
            inp.addEventListener("keydown", function(e) {
                if (e.keyCode == 13) {
                    ...
                    saveButton.innerHTML = 'PRESIONE AQUÍ PARA VALIDAR INGRESO <br> <b>PRECIO COSTO TOTAL: ' + calculatePTotalCost() + '</b>';
        ...
        validateIncome = function() {
            ...
            if (saveButton != null) {
                if (allotments.length < allotmentSelected.length) {
                    saveButton.disabled = false;
                    saveButton.innerHTML = 'INFORMACIÓN DE LOTES INCORRECTA. VOLVER A VALIDAR <br><b>PRECIO COSTO TOTAL: ' + calculatePTotalCost() + '</b>';
                } else {
                    ...
                    if (data.selectedProducts.length > 0) {
                        ...
                        if (!serialValidation) {
                            ...
                            saveButton.disabled = false;
                            saveButton.innerHTML = 'VALIDACIÓN CORRECTA. PRESIONE AQUÍ PARA GUARDAR EL INGRESO <br> <b>PRECIO COSTO TOTAL: ' + calculatePTotalCost() + '</b>';
        ...
        function calculatePTotalCost() {
            pTotalCost = 0;
            data.selectedProducts.forEach(element => {
                var pCost = document.getElementById('priceCost_' + element.id);
                if (pCost != null) {
                    pTotalCost = pTotalCost + parseFloat(pCost.value);
                }
        ...
        saveInventory = function (){
            ...
            var dataSend = {
                ...
                'createdAt': document.getElementById('createdAtDate').value,
            ...
            data.products.forEach(element => {
                ...
                var inputPriceCost = document.getElementById('priceCost_' + element.id);
                if (inputPriceCost != null) {
                    //objElement.priceCost = parseFloat(inputPriceCost.value)/parseFloat(objElement.quantity);
