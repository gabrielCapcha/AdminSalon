...
<script>
    ...
    $(document).ready(function() {
        ...
        saveNewClient = function() {
            ...
            var newTruck = {
                tra_companies_id: document.getElementById('truckTransportCompany').value,
                tra_truck_brands_id: document.getElementById('truckTransportBrand').value,
                model: document.getElementById('truckModel').value,
                number: document.getElementById('truckNumber').value,
            };
            $.ajax({
                method: "POST",
                url: "/api/transport-truck",
                context: document.body,
                data: newTruck,
                statusCode: {
                    400: function() {
                        button.disabled = false;
                        alert("Hubo un error en el registro. Es posible que el camión ya esté registrado.");
                    }
                }
