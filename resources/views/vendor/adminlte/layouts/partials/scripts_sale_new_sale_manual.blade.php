...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                for(i = 0; i < response.length; i++) {
                    // if (response[i].stock > 0) {
                        ...
                        if (count_ < 6) {
                            var buttonHeadClass_ = '<button type="button" align="center" class="info-box-custom-2" id="infoBoxProduct_' + response[i].id + '" onclick="addSelectedProduct( ' + response[i].id + ' );">';
                            ...
                            var buttonHeadClass_ = '<button type="button" align="center" class="info-box-custom" id="infoBoxProduct_' + response[i].id + '" onclick="addSelectedProduct( ' + response[i].id + ' );">';
                            if (response[i].stock < 1) {
        ...
        clearSelectedProduct = function (productId) {
            data.selectedProducts[productId].price = data.selectedProducts[productId].originalPrice;
            data.selectedProducts[productId].partialDiscount = 0;
            data.selectedProducts[productId].quantity = 1;
        ...
        clearAllSelectedProduct = function () {
            ...
            data.padOption = 0;
            data.selectedProducts.forEach(element => {
                clearSelectedProduct(element.id);
            });
        }
