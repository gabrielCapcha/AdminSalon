        ...
        var saleIndexTable = $('#sale_index').DataTable({
            ...
            "columns"    : [
                ...
                {'data': function (data, type, dataToSet) {
                    ...
                    var enabledSync = "";
                    var enabledDetail = "";
                    if (data.json_documents == null) {
                        enabledDetail = 'disabled';
                    }
                    if (data.flag_send == 1) {
                    ...
                    var message = '<button type="button" ' + enabledDetail + ' class="btn btn-info btn-xs" onClick="summaryDocumentsDetail(' + data.id + ')">DETALLE</button> ' +
