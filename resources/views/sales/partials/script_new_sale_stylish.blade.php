    ...
    $(document).ready(function() {
        ...
        // functions
            ...
            function callProductsListeners(product, employeeId, countItemKey){
                ...
                document.getElementById(`partialDiscount_${product.id }${employeeId ? "_" + employeeId : "" }`).addEventListener("keyup", function(event) {
                // document.getElementById('partialDiscount_' + product.id).addEventListener("keyup", function(event) {
                    ...
                    var discount = document.getElementById(`partialDiscount_${product.id }${employeeId ? "_" + employeeId : "" }`);
                ...
                document.getElementById('quantityProduct_' + product.id + '_' + employeeId).addEventListener("keyup", function(event) {
                    ...
                    if (data.selectedProducts[countItemKey].stock < document.getElementById('quantityProduct_' + product.id + '_' + employeeId).value && product.type != 2 && isQuotation !== 'COT') {
        ...
        //var functions
            ...
            addAllCommissions = function () {
                ...
                userList.forEach(element => {
                    ...
                    if (addCommissionProduct != undefined) {
                        ...
                        addSelectedProduct(addCommissionProduct, false, element.id);
                ...
                if (selector.value == 0) {
                    addSelectedProduct(preAddProduct, false, parseInt(selector.value));
                }
            ...
            addSelectedProduct = function (product, quantityLegal = false, employeeId ) {
                ...
                if (!quantityLegal) {
                    ...
                    if (rowEmployee != undefined) {
                        ...
                        '<td class="static-table-td-input"><input type="number" ' + editProductPrice + ' id="priceProduct_' + product.id + '_' + employeeId +'" value="' + product.price + '" onClick="this.select();"></td>' + 
                        '<td class="static-table-td-input" style="padding-left: 0px;"><i style="color: #ffffff;" id="partialDiscountSymbol_' + product.id + '">' + getCurrencySymbolCode(data.currency) + ' </i><input type="number" onClick="this.select();" id="partialDiscount_' + product.id + '_' + employeeId + '" value=0></td>' +
                        '<td class="static-table-td-input"><input type="number" onClick="this.select();" id="quantityProduct_' + product.id + '_' + employeeId +'" value=' + product.quantity + '></td>';
                    } else {
                        var trinnerHTML_ = '<td class="static-table-td" onClick="showProductDetail('+ product.id +')"><strong style="cursor:pointer;">' + product.code + '</strong></td>' +
                    ...
                    if (product.allotmentType == 2) {
                        ...
                        '<button type="button" onclick="clearSelectedProduct(' + product.id + ');" class="btn btn-danger btn-flat"><i class="fa fa-trash"></i></button></span></div></td>';   
                    } else if (rowEmployee != undefined) {
                        trinnerHTML_ = trinnerHTML_ + '<td class="static-table-td"><div class="input-group input-group-sm"><span class="input-group-btn"><button type="button" onclick="clearSelectedProduct(' + product.id + ',' + employeeId + ');" class="btn btn-danger btn-flat"><i class="fa fa-trash"></i></button></span></div></td>';
                    } else {
                        trinnerHTML_ = trinnerHTML_ + '<td class="static-table-td"><div class="input-group input-group-sm"><span class="input-group-btn"><button type="button" onclick="clearSelectedProduct(' + product.id + ',' + 0 + ');" class="btn btn-danger btn-flat"><i class="fa fa-trash"></i></button></span></div></td>';
                    }
                    ...
                    countItemKey++;
                    var productQuantity = document.getElementById('quantityProduct_' + product.id + '_' + employeeId);
                    if (product.stock == 0) {
            ...
            clearSelectedProduct = function (productId, employeeId) {
                ...
                selectedProducts___.forEach(element => {
                    if (element.id !== productId || element.createdBy !== employeeId) {
                        data.selectedProducts[countItemKey] = element;
                        countItemKey++
                    } else {
            ...
            clearAllSelectedProduct = function () {
                ...
                data.padOption = 0;            
                data.selectedProducts.forEach(element => {
                    document.getElementById("row_" + element.id + "_" + element.createdBy).remove();
