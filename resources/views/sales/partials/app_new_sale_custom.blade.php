...
<head>
    ...
    <style>
        ...
        .loadingTrue:not(:required):after {
            content: 'APLICANDO PROMOCIONES';
            display: block;
            font-size: 10px;
            width: 1em;
        ...
        .loadingFalse:not(:required):after {
            content: 'QUITANDO PROMOCIONES';
            display: block;
            font-size: 10px;
            width: 1em;
...
<div id="app">
    <div class="wrapper">
        @include('sales.partials.mainheader_new_sale')
        <div class="content-wrapper" style="padding-top: 59px;">
            @yield('main-content')
        </div>
...
@section('scripts')
    @include('sales.partials.scripts_new_sale_custom')
@show
</body>
</html>