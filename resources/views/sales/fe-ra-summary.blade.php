@extends('sales.partials.app-fe-ra-summary')

@section('sidebar_sales')
active
@endsection

@section('sidebar_communication')
active
@endsection

@section('contentheader_title')
	{{ trans('message.sidebar_communication') }}
@endsection
                        ...
                        <div class="box-body" style="margin: 10px;">
                            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="row">
                                    ...
                                    <div class="modal fade" id="modal-summary-documents-detail">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header" align="center">
                                                ...
                                                <div class="modal-body" align="center">
                                                    <table class="table">
                                                        <thead>
                                                            ...
                                                            <th>{{ trans('message.pdf') }}</th>
                                                            <th>{{ trans('message.xml') }}</th>
                                                            <th>{{ trans('message.cdr
                                                            ') }}</th>
                                                        </thead>
