@extends('sales.partials.app_new_sale_custom')
        ...
        <div class="new-sale-custom-right">
            ...
            <div class="col-md-12" style="height: 43.25%; background: #1e282c;">
                <div class='keypad' align="center">
                    ...
                    <div class='keys col-md-12'>
                        <div class='row' id="optionButtons">
            ...
            <div class="modal fade" id="modal-credit-payment">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" id="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title">CONFIGURAR PAGO A CRÉDITO</h4>
                            <div id="amount"></div>
                        </div>
                        <div class="col-md-12" style="padding:10px;">
                            <!-- form start -->
                            <div class="col-sm-6">
                                <label for="new_user_assignment">Cuota inicial?</label>
                                <select id="credit-type-initial-quote" onChange="onChangeCreditTypeInitialQuote();" class="form-control">
                                    <option value="0">No</option>
                                    <option value="1">Si - Ingresar</option>
                                    <option value="2">Si - Calcular</option>
                                </select>
                                <br>
                                <label for="new_user_assignment">Número de cuotas</label>
                                <input type="number" style="width: 100%" id="numberQuotes" class="form-control" placeholder="Ingrese número de cuotas">
                                <br>
                                <label for="new_user_assignment">Tipo de crédito</label>
                                <select id="credit-type-selector" class="form-control">
                                    <option value="0">SELECCIONE UN TIPO DE CRÉDITO</option>
                            ...
                            <div class="col-sm-6">
                                <label for="new_user_assignment">Valor abonado</label>
                                <input type="number" readonly onChange="onChangeInitialQuote();" style="width: 100%" id="credit-amount" class="form-control">
                                <br>
                                <label for="new_user_assignment">Valor de cuota</label>
                                <input type="number" readonly style="width: 100%" id="quote-value" class="form-control" placeholder="faltan número de cuotas">
                                <br>
                                @php
                                    $hoy=date("Y-m-d");
                                @endphp
                                <label for="new_user_assignment">Día de pago</label>
                                <input id="payment-date" type="date" style="height: 34px; border-radius: 4px; width: 100%;" class="form-control" required min={{$hoy}}> 
                            </div>
                        </div>
                        <div class="modal-footer">
                            <br>
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancelar</button>
                            <button type="button" id="validateCreditPayment" onClick="validateCreditPayment();" class="btn btn-success">Validar</button>
                            <button type="button" id="saveCreditPayment" disabled=true onClick="saveCreditPayment();" class="btn btn-primary" data-dismiss="modal">Guardar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
