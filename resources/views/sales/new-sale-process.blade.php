@extends('adminlte::layouts.app_new_sale_process')

@section('sidebar_sales')
active
@endsection
@section('new_sale_process')
active
@endsection

@section('htmlheader_title')
	{{ trans('message.new_sale_process') }}
@endsection
                ...
                <div class='keypad' align="center">
                    ...
                    <div class='keys col-md-9'>
                        <div class='row'>
                            ...
                            <button disabled><i class="fa fa-clone"></i></button>
                        </div>
                        <div class='row'>
                        ...
                        <div class='row'>
                            ...
                            <button disabled><i class="fa fa-money"></i></button>
                        </div>
                        <div class='row'>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="modal-body">
                                        <!-- TABLA DE PRODUCTOS -->
                                        <label>Guías de remisión afectadas</label>
                                        <table class="table static-table-body-summary">
                                            <thead>
                                                <tr>
                                                    <th>Ticket</th>
